...
class BlockList:
    ...
    def add_list_old_blocks_check_by_entity(self): 
        ...
        self.add_block(name='SIMBOLO-SOLDA-EM-V-CONVEXA', description='Bloco de Símbolo de Solda em V Convexa', entity=Entity(dxftype='LINE', color = ACI.MAGENTA))
        self.add_block(name='SIMBOLO-SOLDA-EM-V-CONVEXA-DESCONTINUA', description='Bloco de Símbolo de Solda em V Convexa Descontínua', entity=Entity(dxftype='LINE', color = ACI.MAGENTA))
        self.add_block(name='SIMBOLO-SOLDA-EM-V-CONVEXA-DOS-DOIS-LADOS', description='Bloco de Símbolo de Solda em V Convexa dos Dois Lados', entity=Entity(dxftype='LINE', color = ACI.MAGENTA))
        self.add_block(name='SIMBOLO-SOLDA-EM-V-DOS-DOIS-LADOS', description='Bloco de Símbolo de Solda em V dos Dois Lados', entity=Entity(dxftype='LINE', color = ACI.MAGENTA))
        self.add_block(name='SIMBOLO-SOLDA-EM-V-PLANA', description='Bloco de Símbolo de Solda em V Plana', entity=Entity(dxftype='LINE', color = ACI.MAGENTA))
        self.add_block(name='SIMBOLO-SOLDA-FILETE', description='Bloco de Símbolo de Solda de Filete', entity=Entity(dxftype='LINE', color = ACI.MAGENTA))
        self.add_block(name='SIMBOLO-SOLDA-FILETE-COM-PERNA', description='Bloco de Símbolo de Solda de Filete com Perna', entity=Entity(dxftype='LINE', color = ACI.MAGENTA))
        self.add_block(name='SIMBOLO-SOLDA-FILETE-COM-PERNA-DESCONTINUA', description='Bloco de Símbolo de Solda de Filete com Perna Descontínua', entity=Entity(dxftype='LINE', color = ACI.MAGENTA))
        self.add_block(name='SIMBOLO-SOLDA-FILETE-COM-PERNA-DESCONTINUA-COINCIDENTE', description='Bloco de Símbolo de Solda de Filete com Perna Descontínua Coincidente', entity=Entity(dxftype='LINE', color = ACI.MAGENTA))
        self.add_block(name='SIMBOLO-SOLDA-FILETE-COM-PERNA-DOS-DOIS-LADOS', description='Bloco de Símbolo de Solda de Filete com Perna dos Dois Lados', entity=Entity(dxftype='LINE', color = ACI.MAGENTA))
        self.add_block(name='SIMBOLO-SOLDA-FILETE-DESCONTINUA', description='Bloco de Símbolo de Solda de Filete Descontínua', entity=Entity(dxftype='LINE', color = ACI.MAGENTA))
        self.add_block(name='SIMBOLO-SOLDA-FILETE-DESCONTINUA-COINCIDENTE', description='Bloco de Símbolo de Solda de Filete Descontínua Coincidente', entity=Entity(dxftype='LINE', color = ACI.MAGENTA))
        self.add_block(name='SIMBOLO-SOLDA-FILETE-DESCONTINUA-INTERCALADA', description='Bloco de Símbolo de Solda de Filete Descontínua Intercalada', entity=Entity(dxftype='LINE', color = ACI.MAGENTA))
        self.add_block(name='SIMBOLO-SOLDA-FILETE-DOS-DOIS-LADOS', description='Bloco de Símbolo de Solda de Filete dos Dois Lados', entity=Entity(dxftype='LINE', color = ACI.MAGENTA))
        self.add_block(name='SIMBOLO-SOLDA-RETA-CONVEXA', description='Bloco de Símbolo de Solda Reta Convexa', entity=Entity(dxftype='LINE', color = ACI.MAGENTA))
        self.add_block(name='SIMBOLO-SOLDA-RETA-CONVEXA-DESCONTINUA', description='Bloco de Símbolo de Solda Reta Convexa Descontínua', entity=Entity(dxftype='LINE', color = ACI.MAGENTA))
    ...
    def add_list_blocks_check_scale(self):
        ...
        self.add_block(name='POS', description='Bloco de Indicação de Posição', allowed_scales=[0.8, 1.0], allowed_rotations=[0.0, 180.0], allow_mirrored=True)
        self.add_block(name='POS2', description='Bloco de Indicação de Posição', allowed_scales=[0.8, 1.0], allowed_rotations=[0.0, 180.0], allow_mirrored=True)
