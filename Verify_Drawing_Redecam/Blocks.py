...
class BlockList:
    ...
    def add_list_blocks_check_scale(self):
        ...
        self.add_block(name='MARK', description='Bloco de Indicação de Peça', allowed_scales=[1.0], allow_mirrored=True)
        ...
        self.add_block(name='PRELIMINARY_BIG', description='Bloco de Carimbo Grande', allowed_scales=[1.0], allow_mirrored=False)
