class ErrorDrawing: 
    def __init__(self):
        ...
        self.ed04 = {'description': ':lady_beetle: [Error ED04:](<https://docs.satusequipamentos.com.br/docs/chloe/erros-de-desenho#error-ed04>) A mesma pessoa está atribuída a mais de um papel na Revisão de Pares.','boolean_value': False }
        self.ed05 = {'description': ':lady_beetle: [Error ED05:](<https://docs.satusequipamentos.com.br/docs/chloe/erros-de-desenho#error-ed05>) A Revisão de Pares do Bloco de Revisão 0 deve ser igual ao Bloco de Título.','boolean_value': False }
        ...
        self.ed15 = {'description': ':lady_beetle: [Error ED15:](<https://docs.satusequipamentos.com.br/docs/chloe/erros-de-desenho#error-ed15>) Peso no Bloco de Peça com ponto.','boolean_value': False }
        ...
        self.ed26 = {'description': ':lady_beetle: [Error ED26:](<https://docs.satusequipamentos.com.br/docs/chloe/erros-de-desenho#error-ed26>) Lista de Blocos na escala errada:\n','boolean_value': False }
