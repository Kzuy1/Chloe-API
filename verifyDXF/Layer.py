class LayerList:
    ...
    def add_default_layer(self):
        self.add_layer("0", True, False, False, 3, "Continuous", -3)
        self.add_layer("ALTRI IMPIANTI", True, False, False, 9, "Continuous", -3)
        self.add_layer("ASSI", True, False, False, 1, "CENTER2", -3)
        self.add_layer("CONTORNI 2", True, False, False, 4, "Continuous", -3)
        self.add_layer("CONTORNI 3", True, False, False, 7, "Continuous", -3)
        self.add_layer("CONTORNI", True, False, False, 2, "Continuous", -3)
        self.add_layer("Defpoints", True, False, False, 7, "Continuous", -3)
        self.add_layer("ESISTENTE", True, False, False, 8, "PHANTOM2", -3)
        ...
        self.add_layer("NASCOSTE", True, False, False, 6, "HIDDEN", -3)
        self.add_layer("NOTE", True, False, False, 3, "Continuous", -3)
        ...
        self.add_layer("SOTTILI", True, False, False, 1, "Continuous", -3)
        self.add_layer("TESTI", True, False, False, 4, "Continuous", -3)
        self.add_layer("TRATTEGGI", True, False, False, 1, "Continuous", -3)
