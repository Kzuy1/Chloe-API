class ErrorDrawing: 
    def __init__(self):
        ...
        self.ed04 = {'description': ':lady_beetle: [Error ED04:](<https://docs.satusequipamentos.com.br/docs/chloe/erros-de-desenho#error-ed04>) Bloco de Legenda está com DRAW, CHECKED ou APPROVED errado.','boolean_value': False }
        ...
        self.ed07 = {'description': ':lady_beetle: [Error ED07:](<https://docs.satusequipamentos.com.br/docs/chloe/erros-de-desenho#error-ed07>) Camada "CONTOUR EXI" está presente no Desenho.','boolean_value': False }
        self.ed08 = {'description': ':lady_beetle: [Error ED08:](<https://docs.satusequipamentos.com.br/docs/chloe/erros-de-desenho#error-ed08>) Linha de Chamada não está na camada QUOTE.','boolean_value': False }
        ...
        self.ed13 = {'description': ':lady_beetle: [Error ED13:](<https://docs.satusequipamentos.com.br/docs/chloe/erros-de-desenho#error-ed13>) Bloco de Legenda não está com data de ','boolean_value': False }
        ...
        self.ed23 = {'description': ':lady_beetle: [Error ED23:](<https://docs.satusequipamentos.com.br/docs/chloe/erros-de-desenho#errored-23>) Fator de Escala ou Nome da cota incorreta:\n','boolean_value': False }
